[README_DEPLOY.md](https://github.com/user-attachments/files/27118154/README_DEPLOY.md)
# Pathwise Future Scan

Pathwise is now a static front end plus a small Node.js backend or Netlify Function for the floating SiliconFlow AI consultation box.
...
2. Put your SiliconFlow API key in `.env`:
...
Never put `SILICONFLOW_API_KEY` inside front-end files. It must be configured only on the backend/server.
